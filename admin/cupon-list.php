              ...
              <table id="example" class="table align-items-center table-flush">
                ...
                ?>
                 <tr>
                  ...
                  <td>
                     <a style="margin-right:10px" href="add-cupon.php?id=<?php echo $value['id']?> & code=<?php echo $value['code']?> & price=<?php echo $value['discount']?>">Edit</a>

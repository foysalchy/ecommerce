              ...
              <table id="example" class="table align-items-center table-flush">
                <thead class="thead-light">
                  <tr>
                    ...
                    <th scope="col" class="sort" data-sort="name"  >KYC</th>
                ...
                ?>
                 <tr>
                   ...
                   <?php if($value['kycStatus']=='1'){echo '<td style="color:green">VERIFY</td>';}else{echo '<td style="color:red">UNVERIFY</td>';}?>

               ...
               <form action="" method="post">
                    ...
                    <?php if(isset($msg)){echo $msg;}?>
                         ...
                         <div class="form-group">
                              ...
                              <input name="name" value="<?php echo $v['name'];?>" class="form-control" type="text"autocomplete="off"  />
                         </div>
                         <div class="form-group">
                              <label>Email <sup style="color: red;">*</sup></label>
                              <input class="form-control"  value="<?php echo $v['email'];?>" type="email"name="email" autocomplete="off"  />
                         </div>
                          <div class="form-group">
                              <label>Mobile <sup style="color: red;">*</sup></label>
                              <input value="<?php echo $v['mobile']?>" class="form-control" type="text"name="mobile" autocomplete="off"  />
                         </div>
                         <div class="form-group">
                              <label>Address <sup style="color: red;">*</sup></label>
                              <input value="<?php echo $v['address']?>" class="form-control" type="text"name="address" autocomplete="off"  />
                         </div>
                        
                          <div class="form-group">
                              <label>Nominee <sup style="color: red;">*</sup></label>
                              <input value="<?php echo $v['nominee']?>" class="form-control" type="text"name="nominee" autocomplete="off"  />
                         </div>
                         <div class="form-group">
                         ...
                         <div class="form-group">
                              ...
                              <input class="form-control" type="text" name="pin" value="<?php echo $v['pin']?>" autocomplete="off"  />
                         </div>
                        <div class="form-group">

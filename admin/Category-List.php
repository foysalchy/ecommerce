              ...
              <table id="example" class="table align-items-center table-flush">
                ...
                ?>
                 <tr>
                   ...
                   <td><?php echo $value['catSlug']?></td>
                   <td><?php if($value['status']==1){echo '<span style="color:green">Active</span>';}else{echo '<span style="color:red">Deactive</span>';}?></td>
                   <td>
                     <a style="margin-right:10px" href="Add-Category.php?id=<?php echo $value['id']?> & name=<?php echo $value['catName']?> & status=<?php echo $value['status']?>">Edit</a>

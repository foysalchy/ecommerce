              ...
              <table id="example" class="table align-items-center table-flush">
                ...
                ?>
                 <tr>
                   ...
                   <td><?php echo $value['stateSlug']?></td>
                   <td>
                     <a style="margin-right:10px" href="Add-State.php?id=<?php echo $value['id']?> & name=<?php echo $value['stateName']?>">Edit</a>

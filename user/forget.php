               ...
               <?php
                    ...
                    <form action="" method="post">
                         <div class="form form2">
                              <h4 style="color:#002f5f;text-align: left;padding:10px 0px;"><b>Forget Password </b></h4>
                              <div class="form-group">
                                   <label>Email <sup style="color: red;">*</sup></label>
                                   <input name="email" class="form-control" type="email"autocomplete="off" required />
                              </div>
                             
                              <input  class="form-control" type="submit" value="Reset" name="" id="">
                              <br>
                              <span style="display: block;text-align: center;"><a href="login.php">Login</a></span>
                         </div>
